...
| L6 Stellar ⭐️ | Near-comprehensive security with continuous improvement |  * Secure the developers <br/>* Tightly controlled access to repositories <br/>* Peer review for main branch commits <br/>* Hardened CI environments <br/>* Build provenance by build service <br/>* SBOM with build time information <br/>* Pin dependencies <br/>* Proxified package manager |
...
| Event Horizon ♾️ | Beyond established practices |  * Hermetic builds <br/>* Indefinite retention of release build environments |
